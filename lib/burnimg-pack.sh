...
sudo mkimage -C none -A arm -T script -d packages/bsp/aml-s812/sdburning.ini output/amlimg/boot.scr 
sudo zip $sdimg output/amlimg/boot.scr  output/amlimg/boot.simg output/amlimg/rootfs.simg
